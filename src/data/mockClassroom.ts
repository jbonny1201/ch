...
export const CLASSROOM_TRASH_ITEMS: InteractiveTrashItem[] = [
  {
    ...
    hint: "교실 왼쪽 아래에 있는 놀이 매트 장난감 상자 옆을 살펴보세요!",
  ...
  },
  {
    ...
    hint: "교실 오른쪽 구석, 선생님의 피아노 옆 책상 위에 올려져 있어요!",
  ...
  },
  {
    ...
    hint: "교실 왼쪽 끝 책장에 장난감 블록들과 함께 끼어있답니다!",
  ...
  },
  {
    ...
    hint: "교실 오른쪽 보들보들한 곰인형 쿠션 옆 바닥에 떨어져 있어요!",
  ...
  },
  {
    ...
    hint: "교실 중앙 시계 바로 아래의 책상 구석에 올려져 연기가 나고 있어요!",
